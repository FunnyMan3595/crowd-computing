...
public record DefaultWorksites(String name, String material, int upgrade_slot_count, int input_slot_count,
		int tool_slot_count, int output_slot_count, int stack_size) {
	public static DefaultWorksites WOOD = new DefaultWorksites("wood", "wood", 0, 1, 1, 1, 1);
	public static DefaultWorksites STONE = new DefaultWorksites("stone", "stone", 0, 2, 1, 1, 4);
	public static DefaultWorksites IRON = new DefaultWorksites("iron", "metal", 1, 3, 1, 2, 16);
	public static DefaultWorksites GOLD = new DefaultWorksites("gold", "metal", 1, 4, 2, 4, 64);
	public static DefaultWorksites DIAMOND = new DefaultWorksites("diamond", "metal", 2, 5, 2, 6, 64);
	public static DefaultWorksites NETHERITE = new DefaultWorksites("netherite", "metal", 3, 6, 2, 9, 64);
	...
	public void writeConfig() throws IOException {
		...
		default_worksite.addProperty("material", material);
